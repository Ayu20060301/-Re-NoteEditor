...
namespace NoteEditor.Model
{
    public class EditState : SingletonMonoBehaviour<EditState>
    {
        ...
        ReactiveProperty<NotePosition> jumpNoteTailPosition_ = new ReactiveProperty<NotePosition>();
        ...
        public static ReactiveProperty<NotePosition> jumpNoteTailPosition { get { return Instance.jumpNoteTailPosition_; } }
    }
}
